...
Individual decks can alternatively put an HTTP(S) CSS URL in their YAML `theme` directive. See [Slides Custom Themes](23.SlidesCustomTheme.md#use-a-remote-theme-url) for temporary caching and revalidation behavior.
